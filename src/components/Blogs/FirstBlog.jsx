      ...
      <div className="bg-[#111111] text-white">
        ...
        <div className="max-w-screen-2xl mx-auto px-5">
          ...
          <div className="max-w-7xl mx-auto py-10">
            ...
            {/*  */}
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Future-oriented innovations</h3>
            ...
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Data mining</h3>
            ...
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Efficient testing & bug detection</h3>
            <p className="py-2">AI-powered testing allows the simulation of hundreds of game scenarios to find glitches and bugs and resolve issues faster and more effectively than manually-run tests.</p>
