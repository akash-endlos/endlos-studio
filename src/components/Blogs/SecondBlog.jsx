      ...
      <div className="bg-[#111111] text-white">
        ...
        <div className="max-w-screen-2xl mx-auto px-5">
          ...
          <div className="max-w-7xl mx-auto py-10">
            ...
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">What is the impact of virtual reality transforming the structure of a building?</h3>
            ...
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">A better clients experience</h3>
            ...
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">VR can help you beat your competition</h3>
            ...
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Collaboration using VR</h3>
            ...
            {/*  */}
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Reduce time by using VR</h3>
            ...
            {/*  */}
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Designer tool</h3>
            ...
            {/*  */}
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">The benefits of Virtual reality in architecture</h3>
            ...
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">The Future of Virtual Reality</h3>
            ...
            {/*  */}
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Conclusion</h3>
