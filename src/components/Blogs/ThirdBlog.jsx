    ...
    <div className="w-full">
      ...
      <div className="bg-[#111111] text-white">
        <div className="py-24 flex items-center justify-center">
          <h1 className="text-5xl max-w-7xl mx-auto px-5 font-bold">The Unreal Engine 5.2 is available!</h1>
        </div>
        <div className="max-w-screen-2xl mx-auto px-5">
          ...
          <div className="max-w-7xl mx-auto py-10">
            ...
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">New features in Unreal Engine 5.2</h3>
            <p className="py-2">Here are some things you can expect from the new version.</p>
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Procedural Content Generation (PCG)</h3>
            ...
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Substrate</h3>
            ...
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Path Tracing</h3>
            ...
            {/*  */}
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Animation</h3>
            ...
            {/*  */}
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Metahumans</h3>
            ...
            {/*  */}
            <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Verse</h3>
            ...
            {/*  */}
             {/*  */}
             <h3 className="text-3xl font-bold max-w-7xl mx-auto py-5 px-5">Virtual Production</h3>
