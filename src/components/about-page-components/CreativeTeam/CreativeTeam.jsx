            ...
            <div className="mx-auto max-w-screen-2xl py-5  ">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                    <div class="grid gap-2 lg:gap-16 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        <div class="text-center text-gray-500 dark:text-gray-400">
                            ...
                            <h4 class="mb-1 text-lg font-bold tracking-tight text-gray-900 dark:text-white">
                ...
                {/* <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 pb-10 text-center">
                    <div className=" p-4 ">
                        ...
                        <h4 className="text-lg font-semibold mb-2 text-[#b6b6b6]">YASH PATEL</h4>
                        <p className="text-[#b6b6b6]"> CEO of Endlos group</p>
                    </div>
                    <div className=" p-4 ">
                        <img className="w-full h-48 object-cover mb-2" src="/assets/humanicon-01.png" alt="Card Image" />
                        <h4 className="text-lg font-semibold mb-2 text-[#b6b6b6]">KHILAN PATEL</h4>
                        <p className="text-[#b6b6b6]"> Founder of  Endlos group</p>
                    </div>
                    <div className=" p-4 ">
                        <img className="w-full h-48 object-cover mb-2" src="/assets/humanicon-01.png" alt="Card Image" />
                        <h4 className="text-lg font-semibold mb-2 text-[#b6b6b6]">ROHIT NAIR</h4>
                        <p className="text-[#b6b6b6]"> Unreal Engine Lead</p>
                    </div>
                    <div className=" p-4 ">
                        <img className="w-full h-48 object-cover mb-2" src="/assets/humanicon-01.png" alt="Card Image" />
                        <h4 className="text-lg font-semibold mb-2 text-[#b6b6b6]">NIKESH MORE</h4>
                        <p className="text-[#b6b6b6]">Unreal Engine Artist</p>
                    </div>
                    <div className=" p-4 ">
                        <img className="w-full h-48 object-cover mb-2" src="/assets/humanicon-01.png" alt="Card Image" />
                        <h4 className="text-lg font-semibold mb-2 text-[#b6b6b6]">PAVAN BORSE</h4>
                        <p className="text-[#b6b6b6]">Unreal Engine Artist</p>
                    </div>
                    <div className=" p-4 ">
                        <img className="w-full h-48 object-cover mb-2" src="/assets/humanicon-01.png" alt="Card Image" />
                        <h4 className="text-lg font-semibold mb-2 text-[#b6b6b6]">SAURABH PATEL</h4>
