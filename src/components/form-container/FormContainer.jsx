...
const FormContainer = () => {
    ...
    return (
        <form className="w-full pb-10" onSubmit={handleSubmit(onSubmit)} >
            ...
            <h4 className='text-white pb-10'><span className="font-bold tracking-[.2em] cursor-pointer text-2xl align-middle ">Write Us</span></h4>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full md:w-3/4 px-3 mb-6 md:mb-0">
                    ...
                    <textarea name="message" {...register('message')} id="message" rows="4" className=" outline-none block p-2.5 w-full text-sm text-white bg-black rounded-lg border border-gray-300  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  " placeholder="Write your thoughts..."></textarea>
