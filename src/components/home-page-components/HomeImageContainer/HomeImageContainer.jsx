      ...
      <div className="px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-10">
          <div className="md:order-2">
            <img src="/assets/blog_inside_vr_2.jpg" alt="endlos unreal engine studio" className="w-full h-[500px] rounded-2xl" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-5">
          <div>
            <img src="/assets/blog_inside_vr_2.jpg" alt="endlos unreal engine studio" className="w-full h-auto rounded-2xl" />
          </div>
          <div>
