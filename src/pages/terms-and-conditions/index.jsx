  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Terms and Conditions | Discover Legal Insights " />
        <meta property="og:description" content=" Delve into the intricate labyrinth of contractual obligations and legal parameters with our comprehensive guide on terms and conditions " />
        ...
        <meta property="og:url" content="https://endlos.studio/terms-and-conditions " />
        <meta name="twitter:title" content="Terms and Conditions | Discover Legal Insights " />
        <meta name="twitter:description" content=" Delve into the intricate labyrinth of contractual obligations and legal parameters with our comprehensive guide on terms and conditions" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:url" content="https://endlos.studio/terms-and-conditions " />
      ...
      <div className="pt-24 bg-[#111111] text-white px-5">
        <div className='max-w-screen-2xl mx-auto py-10'>
          ...
          <h3 className='text-2xl pt-5 pb-2'>Acknowledgment</h3>
          ...
          <h3 className='text-2xl pt-5 pb-2'>Changes to These Terms and Conditions</h3>
